...
@Composable
fun AppartementList(viewModel: AppartementViewModel = viewModel(), navController: NavController) {
    ...
    when {
        ...
        errorMessage != null -> Text(text = errorMessage!!, color = Color.Red)
            ...
            items(appartements) { appartement ->
                AppartementCard(appartement = appartement, navController = navController)
            }
        }
    }
}